    ...
    BDconexion con;
     public void Registro_Nuevo(DMaestros pdto) {
      ...
      public void Actualizar(DMaestros pdto){
        String sql="UPDATE maestros SET Id_Maestro=?,Nombre=?, Area=? where Id_Maestro=?";
        ...
        //*******Convertir la imagen a bits*********
           ...
           pst.setString(2,pdto.getNombre());
           pst.setString(3,pdto.getArea());
           pst.setInt(4,pdto.getId_Maestro());
       ...
       public JTable MostrarTablaEle(JTable tblm){
        try {
            String sql="SELECT * FROM maestros where Area='Electromecanica'";
       ...
       public JTable MostrarTablaIGE(JTable tblm){
        try {
            String sql="SELECT * FROM maestros where Area='IGE'";
       ...
       public JTable MostrarTablaIndustrial(JTable tblm){
        try {
            String sql="SELECT * FROM maestros where Area='Industrial'";
       ...
       public JTable MostrarTablaReno(JTable tblm){
        try {
            String sql="SELECT * FROM maestros where Area='Renovables'";
       ...
       public JTable MostrarTablaSistemas(JTable tblm){
        try {
            String sql="SELECT * FROM maestros where Area='Sistemas'";
