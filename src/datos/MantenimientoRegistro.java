...
public class MantenimientoRegistro {
    ...
    public void Registro_Nuevo(DRegistro pdto){
        try {
            ...
            String insertar = "INSERT INTO registromateria(Clave,Nombre_de_la_asignatura,HorasTeoria,HorasPractica,Unidades,Grupo) VALUES(?,?,?,?,?,?)";
    ...
    public void Eliminar(DRegistro pro){
     ...
     public void Actualizar(DRegistro pdto){
        String sql="UPDATE registromateria SET Clave=?, Nombre_de_la_asignatura=?, HorasTeoria=?,HorasPractica=?,Unidades=?,Grupo=? WHERE Clave=?";
        try {
